...
-- manager (3): catalog, orders, inventory, customers, reports and CMS content editing.
INSERT INTO `role_permissions` (`role_id`,`permission_id`,`created_at`,`updated_at`)
...
WHERE `module` IN ('dashboard','products','categories','brands','attributes','variants','tags',
                   ...
                   'customers','reports','notifications','cms')
...
('About Us','about','<h2>About Kupiana</h2><p>Kupiana is an organic pantry store for fresh-ground spices, whole masalas and cold-pressed cooking oils.</p><p>We work with trusted growers and small-batch producers to bring home ingredients that feel cleaner, taste brighter and keep their natural aroma.</p><p>From turmeric, chilli and garam masala to groundnut, sesame and coconut oils, every pack is chosen for freshness, careful packing and a better everyday kitchen routine.</p>',1,'About Kupiana Organic Spices & Oils','Learn about Kupiana organic spices, whole masalas and cold-pressed cooking oils.',@now,@now),
('Privacy Policy','privacy-policy','<h2>Privacy Policy</h2><p>Kupiana respects your privacy and is committed to protecting the personal information you share with us when you browse, register, place an order or contact support. This policy explains what we collect, how we use it and the choices you have.</p><h3>Information we collect</h3><p>We may collect your name, email address, phone number, billing and shipping address, payment details handled by our payment partner, order history, device and browser information, IP address and any messages you send to our team.</p><h3>How we use your information</h3><p>We use your information to create and manage accounts, process orders, arrange delivery, provide customer support, send order updates, prevent fraud, improve the website and share product updates or offers where permitted by law.</p><h3>Sharing and disclosure</h3><p>We share information only when needed to run the store, such as with payment gateways, delivery partners, hosting providers, accounting tools and other service providers who help us operate the business. We may also disclose information when required by law or to protect our rights, customers or systems.</p><h3>Cookies and analytics</h3><p>We may use cookies and similar technologies to keep your session active, remember preferences, measure site performance and improve the shopping experience. You can control cookies through your browser settings, but some features may not work properly without them.</p><h3>Data retention and security</h3><p>We keep order and account information for as long as needed to serve you, meet tax and accounting obligations, resolve disputes and maintain records. We use reasonable administrative, technical and physical safeguards, but no online system can be guaranteed to be completely secure.</p><h3>Your rights</h3><p>You may review, update or request deletion of certain personal information, subject to legal and operational requirements. You can also opt out of promotional emails by using the unsubscribe link in those messages.</p><h3>Contact</h3><p>If you have any questions about this policy or your information, please contact us using the details listed on the Contact page.</p>',1,'Privacy Policy','How Kupiana collects, uses and protects customer information during ecommerce orders.',@now,@now),
('Terms of Use','terms','<h2>Terms of Use</h2><p>These Terms of Use govern access to and use of the Kupiana website, including browsing products, creating an account and placing orders for spices, oils and other pantry items. By using the site, you agree to these terms and to any policies referenced here.</p><h3>Eligibility and account use</h3><p>You agree to provide accurate information when creating an account or placing an order and to keep your login details secure. You are responsible for all activity carried out through your account.</p><h3>Products, pricing and availability</h3><p>We try to keep product descriptions, images, prices and availability accurate, but errors can happen. We may correct mistakes, change prices or cancel an order if information on the site is inaccurate or the item is unavailable.</p><h3>Orders and payment</h3><p>When you place an order, you are making an offer to buy products subject to acceptance by Kupiana. Orders may be declined, limited or cancelled for reasons including stock issues, payment problems, suspected fraud or address verification concerns. Payments must be completed through the available checkout methods.</p><h3>Shipping, delivery and returns</h3><p>Delivery timelines, shipping charges, return eligibility and refund handling are described in our shipping and return policies. Those policies form part of these Terms of Use.</p><h3>Acceptable use</h3><p>You agree not to misuse the website, interfere with its operation, attempt unauthorized access, upload harmful code, scrape data, or use the site for unlawful, misleading or abusive activity.</p><h3>Intellectual property</h3><p>All content on the site, including text, images, logos, graphics and layout, belongs to Kupiana or its licensors and is protected by applicable intellectual property laws. You may not copy, reproduce or distribute site content without permission except where allowed by law.</p><h3>Disclaimers and limitation of liability</h3><p>Products and website content are provided on an as-available basis. To the fullest extent allowed by law, Kupiana is not liable for indirect, incidental or consequential damages arising from use of the website, delays in delivery, product misuse or interruptions outside our reasonable control.</p><h3>Changes to these terms</h3><p>We may update these terms from time to time. Continued use of the website after changes are posted means you accept the revised terms.</p><h3>Contact</h3><p>If you have questions about these Terms of Use, please contact our support team through the Contact page.</p>',1,'Terms of Use','Terms governing ecommerce browsing, account use, orders, payments and website access at Kupiana.',@now,@now),
