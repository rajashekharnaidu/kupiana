...
$route['admin/(:any)/edit/(:num)'] = 'admin/crud/edit/$2';
$route['admin/(:any)/delete/(:num)'] = 'admin/crud/delete/$2';
...
$route['cart/apply-coupon'] = 'catalog/cart/apply_coupon';
$route['cart/remove-coupon'] = 'catalog/cart/remove_coupon';
...
$route['about'] = 'catalog/pages/show/about';
$route['privacy-policy'] = 'catalog/pages/show/privacy-policy';
$route['terms'] = 'catalog/pages/show/terms';
$route['return-policy'] = 'catalog/pages/show/return-policy';
$route['shipping-policy'] = 'catalog/pages/show/shipping-policy';
$route['checkout'] = 'catalog/checkout/index';
$route['checkout/success/([a-f0-9]{64})'] = 'catalog/checkout/success/$1';
$route['payments/cashfree/pay/([a-f0-9]{64})'] = 'catalog/payments/cashfree_pay/$1';
...
$route['payments/failed/([a-f0-9]{64})'] = 'catalog/payments/failed/$1';
